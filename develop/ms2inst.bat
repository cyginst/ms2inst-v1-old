...
call :dl_from_url %CYG_SETUP% https://github.com/cyginst/ms2inst-v1/raw/master/%CYG_SETUP%
call :dl_from_url 7z.exe https://github.com/cyginst/ms2inst-v1/raw/master/7z.exe
